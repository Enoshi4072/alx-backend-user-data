...
@app.before_request
def before_request():
    """ Auth a user before processing a request """
    if auth is None:
        return
    exempt_paths = ['/api/v1/status/', '/api/v1/unauthorized/', '/api/v1/forbidden/', '/api/v1/auth_session/login/']
